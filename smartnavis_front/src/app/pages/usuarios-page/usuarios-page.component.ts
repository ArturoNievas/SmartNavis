...
export class UsuariosPageComponent implements OnInit {
  ...
  public listarEmbarcaciones(usuario: Usuario): void {
    this.usuarioService.listarEmbarcaciones(usuario).subscribe((embarcaciones: Embarcacion[]) => {
  ...
  public listarPublicaciones(usuario: Usuario): void {
    this.usuarioService.listarPublicaciones(usuario).subscribe((publicaciones: Publicacion[]) => {
